...
public class ConsoleLogTransaction {
    ...
    public void PrintInfoToConsoleSuccess(String name,int amount,int oldBankBal,int newBankBal,int oldEssentialsBal, int newEssentialsBal,String transactionStatus){

        Bukkit.getServer().getConsoleSender().sendMessage(ChatColor.GREEN + "$--------Theatria-Bank-Slip--------$");
        Bukkit.getServer().getConsoleSender().sendMessage(ChatColor.YELLOW + "Player: " + name + ChatColor.YELLOW + " | Withdraw Request: " + ChatColor.GREEN + amount);
    ...
    public void PrintInfoToConsoleFailAtDataBase(String name, int amount, String transactionStatus){
    ...
    public void PrintInfoToConsoleFailAtEssentials(String name, int amount,int oldBankBal,int newBankBal,int oldEssentialsBal, int newEssentialsBal,String transactionStatus){
    ...
    public void PrintInfoToConsoleNSFunds(String name,int amount,int oldBankBal,String transactionStatus){
